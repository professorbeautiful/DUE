...
ui <- fluidPage(
  ...
  fluidRow(
    column(5, 
           h2("Contour plot for thresholds", style='color:blue'),
           fluidRow(
           ...
           fluidRow(
             column(3, style='background-color:lightgray;',
                    numericInput(inputId = "populationNumber", HTML("<br># of Populations"), value = 1)),
             column(3, style='background-color:lightgray;',
                    numericInput(inputId = "thisPopulation", HTML("<br>This Population"), value = 1)),
             column(3,style='background-color:lightgray;',
                    numericInput(inputId = "thisPopFraction", "This Population Fraction", value = 1)),
             column(3, style='background-color:lightgray;',
                    numericInput(inputId = "popFractionFollows", "Which Pop'n Fraction Follows", value = 1))
           ),
           hr(),
           div(
    ...
    column(5
           ...
           , wellPanel(fluidRow(column(2,  HTML("Line thickness controls")), 
                                linethicknessButtons))
           , plotOutput("linePlot")
           ,
           div(
